...
export const themes: Theme[] = [
  ...
  },
 {
  key: "mint",
  label: "Mint",
  swatch: "oklch(0.7500 0.1200 165.0000)",
  light: {
    "--primary":                    "oklch(0.6500 0.1400 165.0000)",
    "--primary-foreground":         "oklch(1.0000 0 0)",
    "--ring":                       "oklch(0.7000 0.1500 165.0000)",
    "--sidebar-primary":            "oklch(0.7000 0.1500 165.0000)",
    "--sidebar-primary-foreground": "oklch(0.9800 0.0200 165.0000)",
    "--sidebar-ring":               "oklch(0.7000 0.1500 165.0000)",
    "--chart-1":                    "oklch(0.7200 0.1600 165.0000)",
  },
  dark: {
    "--primary":                    "oklch(0.6000 0.1300 165.0000)",
    "--primary-foreground":         "oklch(0.9500 0.0300 165.0000)",
    "--ring":                       "oklch(0.6500 0.1500 165.0000)",
    "--sidebar-primary":            "oklch(0.6500 0.1500 165.0000)",
    "--sidebar-primary-foreground": "oklch(1.0000 0 0)",
    "--sidebar-ring":               "oklch(0.6500 0.1500 165.0000)",
    "--chart-1":                    "oklch(0.6000 0.1300 165.0000)",
  },
},
  {
    key: "purple",
...
},
{
  key: "ruby",
  label: "Ruby",
  swatch: "oklch(0.4800 0.1200 20.0000)",
  light: {
    "--primary":                    "oklch(0.4800 0.1200 20.0000)",
    "--primary-foreground":         "oklch(1.0000 0 0)",
    "--ring":                       "oklch(0.5500 0.1300 20.0000)",
    "--sidebar-primary":            "oklch(0.5500 0.1300 20.0000)",
    "--sidebar-primary-foreground": "oklch(0.9800 0.0200 20.0000)",
    "--sidebar-ring":               "oklch(0.5500 0.1300 20.0000)",
    "--chart-1":                    "oklch(0.5200 0.1400 20.0000)",
  },
  dark: {
    "--primary":                    "oklch(0.4200 0.1100 20.0000)",
    "--primary-foreground":         "oklch(0.9800 0.0200 20.0000)",
    "--ring":                       "oklch(0.5000 0.1200 20.0000)",
    "--sidebar-primary":            "oklch(0.5000 0.1200 20.0000)",
    "--sidebar-primary-foreground": "oklch(1.0000 0 0)",
    "--sidebar-ring":               "oklch(0.5000 0.1200 20.0000)",
    "--chart-1":                    "oklch(0.4200 0.1100 20.0000)",
  },
},
];
