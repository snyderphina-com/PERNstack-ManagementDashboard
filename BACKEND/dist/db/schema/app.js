...
import { boolean, integer, jsonb, index, pgEnum, pgTable, text, timestamp, varchar, uniqueIndex, } from "drizzle-orm/pg-core";
...
export const adminInvitations = pgTable("admin_invitations", {
    ...
    codeHashUnique: uniqueIndex("admin_invitations_code_hash_unique").on(table.codeHash),
    createdByIdx: index("admin_invitations_created_by_idx").on(table.createdBy),
}));
